...
- Name: checkoutPayment.spec.js >> Checkout and Payment Service >> test suits which need to login >> Test-09: Verify order summary in the confirm order step matches cart items
- Location: tests/checkoutPayment.spec.js:179:9
