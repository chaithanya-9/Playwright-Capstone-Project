...
- Name: checkoutPayment.spec.js >> Checkout and Payment Service >> test suits which need to login >> Test-02: Proceed to checkout as a logged-in user
- Location: tests/checkoutPayment.spec.js:55:9
