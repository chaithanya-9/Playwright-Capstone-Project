...
- Name: authentication.spec.js >> Authentication Service Tests >> Test-09: Verify registration fails if password and confirm password does not match
- Location: tests/authentication.spec.js:135:5
