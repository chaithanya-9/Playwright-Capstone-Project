...
- Name: checkoutPayment.spec.js >> Checkout and Payment Service >> test suites which need to login >> Test-15: Validate total price at checkout matches the final confirmation page
...
> 309 |             expect(summaryText).toContain(productPriceText);
  ...
  318 |     })
  319 | 
  320 |     test.describe('test suites which does not need to login', () => {
  321 |         // test 01
