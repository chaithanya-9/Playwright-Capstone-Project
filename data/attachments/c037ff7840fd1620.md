...
- Name: customerSupport.spec.js >> Customer Support Service Tests >> Test-04: Verify submitting the Contact Us form with an invalid email format triggers a warning
- Location: tests/customerSupport.spec.js:47:5
      ...
      - generic [ref=e85]:
        - group "Contact Form" [ref=e86]:
          ...
          - generic [ref=e92]:
            ...
            - textbox "* E-Mail Address" [ref=e95]: invalidemail@
          - generic [ref=e96]:
            - generic [ref=e97]: "* Enquiry"
            - textbox "* Enquiry" [active] [ref=e99]: This is a test enquiry with an invalid email format to check validation.
